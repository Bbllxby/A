...
for i,v in pairs(game.CoreGui:GetChildren()) do
    if v.Name == "Bbllxby" then 
        v:Destroy()
    end
end

function library:Window(options)
    local TitleUI = options.Title or "Bbllxby Hub"
    local Accent = options.Accent or Color3.fromRGB(112, 191, 255)
    local Logo = options.Logo or '17074287177'
    local Toggle_Key = options.ToggleKey or Enum.KeyCode.LeftBracket

    local Bbllxby = Instance.new("ScreenGui")
    Bbllxby.Name = "Bbllxby"
    Bbllxby.Parent = game.CoreGui
    Bbllxby.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    local Mover = Instance.new("Frame")
    Mover.Name = "Mover"
    Mover.Parent = Bbllxby
    Mover.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    _1LeftSide.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    hider_2.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    Title.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    _2MiddleSide.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    _3Container.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    hider.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
    ...
    function TabsFunc:NewTab(options)
        local Logo = options.Logo or '17074519176'

        local tab_shell = Instance.new("TextButton")
        tab_shell.Name = "tab_shell"
        tab_shell.Parent = Tabs
        tab_shell.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
        ...
        tab_shell.Text = ""
        tab_shell.TextColor3 = Color3.fromRGB(255, 255, 255)
        ...
        middle_scroll.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
        ...
        function mid_sections:TabSection(options)
            ...
            Section_Header.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
            ...
            Section_Header.TextColor3 = Color3.fromRGB(255, 255, 255)
            ...
            Toggle_Section.ImageColor3 = Color3.fromRGB(255, 255, 255)
            ...
            function columns:AddColumn(options)
                ...
                Sec_Option.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                ...
                NewPage.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                ...
                page_name.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                ...
                InnerPage.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        if v:IsA("TextButton") then
                            for i2, pname in next, _3Container:GetChildren() do 
                                if pname:FindFirstChild("page_name") then
                                    if v.Sec_Frame.BackgroundColor3 == Color3.fromRGB(23, 23, 27) and middle_scroll.Size == UDim2.new(0,125,0,380) then
                ...
                Sec_Option.MouseButton1Click:Connect(function()
                    for i,v in pairs(Section_Frame:GetChildren()) do
                        if v:IsA("TextButton") then 
                            TweenService:Create(v, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                            TweenService:Create(v.Sec_Frame, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(23, 23, 27)}):Play()
                        end
                    end
                    ...
                    TweenService:Create(Sec_Frame, TweenInfo.new(0.1, Enum.EasingStyle.Linear, Enum.EasingDirection.In), {BackgroundColor3 = Color3.fromRGB(23, 23, 27)}):Play()
                ...
                function frame_sections:Section(options)
                    ...
                    SepFrame.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Button(options)
                        ...
                        uiButton.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Toggle(options)
                        ...
                        uiToggle.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        T1.Name = "T1"
                        T1.Parent = uiToggle
                        T1.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        TextLabel.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:TextLabel(options)
                        ...
                        uiTextlabel.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Divide()
                        ...
                        uiSep.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Keybind(options)
                        ...
                        uiKeybind.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        key_text.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Textbox(options)
                        ...
                        text_shell.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        TextBox.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Dropdown(options)
                        ...
                        uiDropdown.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        Dropdown_Container.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        for i,v in pairs(List) do
                            ...
                            option.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                    ...
                    function main_functions:Slider(options)
                        ...
                        slider_holder.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        slider_name.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
                        ...
                        slider_shell.BackgroundColor3 = Color3.fromRGB(23, 23, 75)
                        ...
                        slider_text.BackgroundColor3 = Color3.fromRGB(23, 23, 27)
